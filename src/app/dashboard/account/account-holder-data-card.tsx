        ...
        <div className="flex items-center justify-between gap-3">
          <div className="flex items-center gap-2 min-w-0">
            ...
            {hasAccountOwnerInfo || hasAltContactInfo ? (
              <p className="text-sm text-gray-600">Account Holder &amp; Alternate Contact on file</p>
            ) : (
              <p className="text-sm text-gray-400">No Account Holder data on file</p>
            )}
          </div>
          <button
        ...
        {hasAccountOwnerInfo && (
          <>
            <p className="text-xs text-gray-500 pl-6">
              Account Holder: {[data.accountOwnerName, data.accountOwnerTitle, data.accountOwnerEmail, data.accountOwnerPhone].filter(Boolean).join(" · ")}
            </p>
  ...
  return (
    <div className="bg-white border rounded-xl p-5">
      <h2 className="font-semibold text-sm text-gray-700 flex items-center gap-2 mb-3">
        <IdCard className="h-4 w-4 text-gray-400" /> Account Holder Data
      </h2>
