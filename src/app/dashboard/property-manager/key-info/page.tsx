...
export default async function PropertyManagerKeyInfoPage() {
  ...
  return (
    <div className="space-y-6">
      <OnboardingStepTracker stepId="pm_key_info" alreadyComplete={onboardingStepDone} />
      <div>
        <h1 className="text-2xl font-bold">Key Information</h1>
        <p className="text-gray-500 mt-1">The Board, key dates, and the institutional contacts owners rely on</p>
      </div>
