...
export default async function PropertyManagerFinancesPage() {
  ...
  const onboardingStepDone = parseCompletedSteps(ownMembership?.onboardingSteps ?? null).has("pm_finances")
  ...
  return (
    <div className="space-y-6">
      <OnboardingStepTracker stepId="pm_finances" alreadyComplete={onboardingStepDone} />
      <div>
