    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1">
          Every unit is listed - only ones whose owner has chosen to share occupancy with the Board show any
          detail. A blank line means either nothing logged or the owner keeping it private - there&apos;s no way
